...
func (app *App) AddHandler(handler Handler) error {
	...
	app.handlers[handler.GetName()] = handler
	return nil
}
...
func (app *App) GetRootHandler() RootHandler {
	return app.rootHandler
}
func (app *App) HasHandler(name string) bool {
	return app.handlers[name] != nil
}
